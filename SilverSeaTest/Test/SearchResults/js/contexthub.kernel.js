...
(function(){var e=function(){var f=window.dataLayer[0].user_geo_adwords;
return f==="US"
};
var c=function(){var f=window.dataLayer[0].user_geo_adwords;
return f==="LAM"
};
var d=function(){var f=window.dataLayer[0].user_geo_adwords;
return f==="EMEA"
};
var b=function(){var f=window.dataLayer[0].user_geo_adwords;
return f==="UK"
};
var a=function(){var f=window.dataLayer[0].user_geo_adwords;
return f==="AP"
};
ContextHub.SegmentEngine.ScriptManager.register("getIsFT",e);
ContextHub.SegmentEngine.ScriptManager.register("getIsLAM",c);
ContextHub.SegmentEngine.ScriptManager.register("getIsEU",d);
ContextHub.SegmentEngine.ScriptManager.register("getIsUK",b);
ContextHub.SegmentEngine.ScriptManager.register("getIsAS",a)
})();
